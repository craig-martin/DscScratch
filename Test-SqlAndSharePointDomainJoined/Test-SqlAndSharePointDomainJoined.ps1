...
configuration SqlAndSharePointDomainJoined
{
...
SqlAndSharePointDomainJoined -ConfigurationData $ConfigurationData -OutputPath c:\temp\SqlAndSharePointDomainJoined

Set-DscLocalConfigurationManager -Path c:\temp\SqlAndSharePointDomainJoined

Start-DscConfiguration -Verbose -Wait -Path c:\temp\SqlAndSharePointDomainJoined -Force